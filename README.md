...
O pipeline integra um **script de inferência** que consome dados da camada **Silver** para prever o **risco de atraso** de pedidos ainda em trânsito (`shipped`, `processing`, `invoiced`).
